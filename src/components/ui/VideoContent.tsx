...
import SportecThaiLogo from "@/asset/image/img_sportecthailand_icon.svg";
...
const event_data: EventData[] = [
  {
    id: "sportecthailand",
    videoId: "2JL-RPvjW44",
    logo: SportecThaiLogo,
    title: "SPORTEC Thailand 2026",
    description:
      "งานแสดงสินค้าและธุรกิจด้านกีฬาและสุขภาพระดับนานาชาติครั้งแรกในประเทศไทย ที่รวมกว่า 250 แบรนด์ชั้นนำจาก 15 ประเทศพร้อมสัมมนาเชิงลึกและกิจกรรมสุดพิเศษในวงการกีฬาและสุขภาพโอกาสครั้งสำคัญในการสร้างเครือข่ายธุรกิจและสัมผัสนวัตกรรมล่าสุดของอาเซียน – ทั้งหมดนี้รวมไว้ในงานเดียว!”​",
    date: "25 มิถุนายน (พฤหัสบดี) – 27 มิถุนายน (เสาร์) 2569​​",
    location: "ศูนย์แสดงสินค้า BITEC - Exhibition Centre",
  },
  {
    id: "sportec",
    videoId: "ixyfwrInOOI",
    ...
    date: "8 กรกฎาคม (พุธ) - 10 กรกฎาคม (ศุกร์) 2569​",
  ...
  },
  {
    ...
    date: "4 สิงหาคม (อังคาร) - 6 สิงหาคม (พฤหัสบดี) 2569​​",
